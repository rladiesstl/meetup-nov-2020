...
author: "Intro to Network Analysis"
...
- All materials can be found here: https://github.com/mcramosf/Intro_Nets_RladiesSTL
...
- Started in San Francisco in 2012 and now has **193 chapters and more than 77,000** members globally (check out rladies.org for a SHINY dashboard)
...
* Fall lineup
    ...
    - **TODAY! Our 17th Meeup**: Nov 11: Intro to Network Analysis with **Dr. Maria C. Ramos** (Duke University)  
...
- Maria has a PhD in Sociology from Duke University

- She is currently a Research Fellow at Duke Network Analysis Center

- Her current projects employ network science to understand HIV prevention, social-ecological systems, collaboration within organizations, and networks of beliefs and mental models
